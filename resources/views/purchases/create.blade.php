...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Pembelian bahan baku atau bahan penolong dengan FOB dan PPN</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="supplier_id" id="supplier_id" required
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            onchange="toggleNewSupplierFields(); filterMaterialsBySupplier();">
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    @error('new_supplier_name')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                                </div>
                                <div>
                                    ...
                                    @error('new_supplier_phone')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                                </div>
                            </div>
                        </div>
                    </div>

                    @php $defaultType = $defaultType ?? 'raw_material'; @endphp
                    <input type="hidden" name="purchase_type" id="purchase_type" value="{{ old('purchase_type', $defaultType) }}">
                    @error('purchase_type')<p class="text-sm text-red-600">{{ $message }}</p>@enderror
                    ...
                    <div>
                        ...
                        <select name="fob_type" id="fob_type" required
                            ...
                            <option value="shipping_point" {{ old('fob_type', 'shipping_point') == 'shipping_point' ? 'selected' : '' }}>
                    ...
                    <div id="fob-cost-container">
                        ...
                        <input type="number" name="fob_cost" id="fob_cost" value="{{ old('fob_cost', 0) }}" min="0" step="0.01"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    ...
                    <div>
                        ...
                        <input type="number" name="ppn_rate" id="ppn_rate" value="{{ old('ppn_rate', 11) }}"
                    ...
                    <div>
                        ...
                        <select name="payment_method" id="payment_method" required
                            ...
                            <option value="credit" {{ old('payment_method') == 'credit' ? 'selected' : '' }}>Hutang</option>
                        </select>
                    ...
                    <div id="down-payment-container" style="display:none;">
                        ...
                        <input type="number" name="down_payment" id="down_payment"
                            value="{{ old('down_payment', 0) }}" min="0" step="1"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            placeholder="0" oninput="calculateTotals()">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                ...
                <button type="button" onclick="addItem()"
                    class="inline-flex items-center px-4 py-2 border border-gray-300 bg-white text-sm leading-4 font-medium rounded-md text-gray-900 shadow-sm hover:bg-gray-50 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1">
...
<script>
    ...
    function calculateItemSubtotal(index) {
        ...
        const rawPrice = (document.querySelector(`input[name="items[${index}][unit_price_display]"]`)?.value || '0')
            .replace(/[^0-9]/g, '');
