...
<body class="font-sans text-gray-900 antialiased bg-cover bg-center bg-no-repeat bg-fixed"
    ...
    <div class="relative min-h-screen flex flex-col">
        ...
        <div class="absolute top-4 left-4 sm:top-6 sm:left-6 z-10">
            <a href="/"
                class="flex items-center space-x-2 sm:space-x-3 px-4 py-2 sm:px-6 sm:py-3 rounded-xl sm:rounded-2xl bg-white/90 backdrop-blur-md shadow-lg border border-[#C9996B]/30 transition-all hover:shadow-xl hover:bg-white">
                <x-application-logo class="h-8 sm:h-10 w-auto" />
                <span class="text-lg sm:text-xl font-bold text-[#5C4F4A]">
                    {{ config('app.name', 'Manufactur Application') }}
                </span>
            </a>
        </div>
        ...
        <div class="flex-grow flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div
                class="max-w-4xl w-full bg-[#5C4F4A] rounded-[2rem] shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[600px] border border-[#C9996B]/20">
                ...
                <div class="hidden md:flex md:w-5/12 relative overflow-hidden bg-white/5 backdrop-blur-3xl">
                    ...
                    <div class="absolute inset-0 opacity-60 bg-cover bg-center blur-2xl scale-125"
                        style="background-image: url('{{ asset('images/backgrounds/auth-bg.png') }}');"></div>
                    <div class="absolute inset-0 bg-gradient-to-br from-[#5C4F4A]/90 via-[#5C4F4A]/40 to-transparent">
                    </div>
                    ...
                    <div class="relative z-10 p-10 flex flex-col justify-between h-full">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <span class="text-white text-sm font-medium tracking-widest uppercase">Telkom
                                University</span>
                        </div>
                    </div>
                </div>
        ...
        <!-- Logo footer -->
        <div class="w-full flex justify-between items-center px-8 py-6 gap-6 border-t border-amber-300/50 backdrop-blur-md"
            style="background: linear-gradient(to right, #fff7ed, #fef3c7, #fff7ed);">
            <div class="text-xs text-gray-700 leading-relaxed">
                ...
                <p>Dr. Nelsi Wisna, S.E., M.Si. &nbsp;·&nbsp; Cindy Kartika Putri &nbsp;·&nbsp; Fauzan Abiyyu Aziz
                    &nbsp;·&nbsp; Hanina Syahida Riyanto &nbsp;·&nbsp; Wa Ode Aura Syania Azzahra</p>
            </div>
