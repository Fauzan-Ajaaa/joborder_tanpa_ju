...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <h1 class="text-3xl font-bold text-gray-900">Tambah Supplier</h1>
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <form action="{{ route('suppliers.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input
                        ...
                        id="code"
                        name="code"
                        value="{{ $nextCode ?? '(otomatis saat disimpan)' }}"
                        class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 shadow-sm" readonly
                    >
                    <p class="mt-1 text-sm text-gray-500">Kode akan digenerate otomatis, tidak perlu diisi.</p>
                </div>
            ...
            <div class="flex items-center justify-end space-x-3 pt-6 border-t">
                <a href="{{ route('suppliers.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-50">
                    Batal
                </a>
