// Password Toggle for Filament Login
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (passwordInput) {
        ...
        toggleButton.className = 'absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-400';
        ...
        if (inputWrapper) {
            ...
            toggleButton.addEventListener('click', function() {
                ...
                eyeOpen.forEach(el => el.classList.toggle('hidden'));
                eyeClosed.forEach(el => el.classList.toggle('hidden'));
            });
        }
    }
});
